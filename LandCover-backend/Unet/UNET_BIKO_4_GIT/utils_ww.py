...
def normalize_data(dataset):
    ...
    np.save('/mnt/users/defausti/highways/'+"max_bands_hw_norm",np.array(max_bands))
    np.save('/mnt/users/defausti/highways/'+"min_bands_hw_norm",np.array(min_bands))
...
def standardize(data):
    ...
    means=np.load('/mnt/users/defausti/highways/'+"means_river.npy")
    std=np.load('/mnt/users/defausti/highways/'+"std_river.npy")

...
base_path_lake='/mnt/users/defausti/highways/'
base_path_lake_RGB=save_path='/mnt/users/defausti/highways/'

name_model='model_unet_2_32_12_1_percentile_min_max_HW'
model_path='./weights/'+name_model

output_folder   ='./output_pred/'
name_pred_file  = 'prediction_hw_'+'model_unet_{}_{}_{}'.format(n_channels,n_epochs,bc_size)

output_path_val= os.path.join(output_folder,name_pred_file)


save_fig_path = './output_pred/plot_prediction/'+'highways_' + name_model
x_train_RGB = np.load(base_path_lake_RGB+'x_train_RGB_Highways.npy')

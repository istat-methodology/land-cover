...
if __name__ == '__main__':
    ...
    name_model="model_unet_2_32_8_2_percentile_min_max_River"#'model_unet_150_32_13_1_min_max_River'
    ...
    save_fig_path='/mnt/users/defausti/waterways/'+ name_model

    file_land_name='LECCE'
    print("----------------------------------------------------")
    ...
    plt.savefig(save_fig_path+"_river_"+ "{}_mask_ww_{}.png".format(file_land_name,trs_river),dpi=1200)
        # plt.close()

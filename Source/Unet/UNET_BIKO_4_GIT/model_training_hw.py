...
x_val_path = save_path + 'x_val_Highways.npy'
x_trn_path = save_path + 'x_train_Highways.npy'

y_val_path = save_path + 'y_val_Highways.npy'
y_trn_path = save_path + 'y_train_Highways.npy' 
